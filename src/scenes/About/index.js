    ...
    <>
      ...
      <Container>
        ...
        <h2 style={{ fontWeight: 300 }}>
          We provide comprehensive direction on all things visual: Branding,
          Album Art, Videos, Photography, and the Live Experience.
          <br />
          <br />
          <br />
          <br />
        ...
        <CardContainer>
          ...
          <Card title="MERCH DESIGN">
            We work with our team of designers to craft merchandise that
            captures a moment and audiences in the artist’s musical timeline.
          </Card>
          <br />
          <Card title="PHOTOGRAPHY">
            We create unique and authentic visual interpretations of each
            artist’s vision.
          </Card>
